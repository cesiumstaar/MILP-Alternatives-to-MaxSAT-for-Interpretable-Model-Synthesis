...
def execute(inputs):
	...
	program_edges[("2",2)]= "species_2"
	program_edges[("2",1)]= "species_1"
	program_edges[("2",0)]= "species_2"
	program_edges[("1",3)]= "species_2"
	program_edges[("1",2)]= "species_2"
	program_edges[("1",1)]= "species_2"
	program_edges[("1",0)]= "species_2"
	program_edges[("0",3)]= "1"
	program_edges[("0",2)]= "2"
